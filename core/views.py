...
from .forms import RegistrationForm, TeamName
...
def registrationpage(request, city_name, event_name):
    ...
    MemberFormSet = modelformset_factory(TeamMember, fields = ['name', 'phone_no', 'email', 'gender', 'institute_name','program_enrolled', 'year_of_passing'], extra=0)  # Start with one member form
